...
The [vimscript](https://learnvimscriptthehardway.stevelosh.com/) is somehow a minority and discourage people to create their plugins or contribute to the Vim project itself. Maybe it's also related to its documentation and grammar design. The contributors of Vim are much less than Neovim.
