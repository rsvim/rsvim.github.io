...
<ul style="width: 100%; display: table; table-layout: fixed; border-collapse: collapse; border-style: none;">
    <li style="display: table-cell; text-align: center; border: none;">
        <p>Vim</p>
        <video width="95%" controls muted>
            <source src="https://github.com/user-attachments/assets/4ceafa5b-cc26-4487-a455-e840485c2595" type="video/mp4"></source>
        </video>
        </li>
    <li style="display: table-cell; text-align: center; border: none;">
        <p>Rsvim</p>
        <video width="95%" controls muted>
            <source src="https://github.com/user-attachments/assets/27d4987c-029f-4f8a-859a-dc633191ae7f" type="video/mp4"></source>
        </video>
    </li>
</ul>
...
<ul style="width: 100%; display: table; table-layout: fixed; border-collapse: collapse; border-style: none;">
    <li style="display: table-cell; text-align: center; border: none;">
        <p>Vim</p>
        <video width="95%" controls muted>
            <source src="https://github.com/user-attachments/assets/2bd950c2-738e-4642-b23b-8703074717dc" type="video/mp4"></source>
        </video>
        </li>
    <li style="display: table-cell; text-align: center; border: none;">
        <p>Rsvim</p>
        <video width="95%" controls muted>
            <source src="https://github.com/user-attachments/assets/4c3c841f-1c95-44d8-8285-a3ba52580652" type="video/mp4"></source>
        </video>
    </li>
</ul>
...
<p align="center">
    <video width="85%" controls muted>
        <source src="https://github.com/user-attachments/assets/feceebac-37e0-40fa-9903-81ec46930631" type="video/mp4"></source>
    </video>
</p>
...
3.  Filetype-based syntax highlighting and colorscheme/theme.
