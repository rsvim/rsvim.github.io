...
For the last location, it doesn't have a config home at all. This will affect the "package" resolving for Rsvim, please refer to [Simple Package](./simple_package.md) for more details.
