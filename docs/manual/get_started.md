...
- (**TODO**: Just like a third-party librariy for a language interpreter, ) [npm package](https://www.npmjs.com/) is also accepted as a compatible plugin schema, and directly installed via the npm registry.
