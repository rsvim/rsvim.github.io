...
- Specific APIs: Different runtimes provide have their own specific APIs, i.e. browsers such Chrome/Firefox provide the [`document` DOM tree](https://developer.mozilla.org/en-US/docs/Web/API/Document) APIs, server-side runtimes such as node/deno provide their own APIs to manage the operating systems.
